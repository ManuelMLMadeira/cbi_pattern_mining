...
%load channels
load('jl_beep_after.mat')
load('jl_beep_before.mat')
load('jl_beep_during.mat')
load('jl_birds_after.mat')
load('jl_birds_before.mat')
load('jl_birds_during.mat')
load('jl_boom_after.mat')
load('jl_boom_before.mat')
load('jl_boom_during.mat')
load('jl_crying_after.mat')
load('jl_crying_before.mat')
load('jl_crying_during.mat')
load('jl_laughing_after.mat')
load('jl_laughing_before.mat')
load('jl_laughing_during.mat')
load('jl_ringing_after.mat')
load('jl_ringing_before.mat')
load('jl_ringing_during.mat')
load('jl_thunder_after.mat')
load('jl_thunder_before.mat')
load('jl_thunder_during.mat')
...
colormap(map)
colorbar
title('Mean of Channels before 1kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during 1kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after 1kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels before 2kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during 2kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after 2kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels before 3kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during 3kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after 3kHz beep, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels before boom, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during boom, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after Boom, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels before ringing, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during ringing, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after ringing, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels before crying, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during crying, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after crying, jl')
drawnow;
%% Laughing
...
colormap(map)
colorbar
title('Mean of Channels before laughing, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during laughing, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after laughing, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels before birds, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during birds, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after birds, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels before thunder, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels during thunder, jl')
drawnow;
...
colormap(map)
colorbar
title('Mean of Channels after thunder, jl')
drawnow;
